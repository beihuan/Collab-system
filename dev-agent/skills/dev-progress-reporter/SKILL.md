...
此 Skill 帮助开发者生成每日工作进度报告。**核心原则：优先从 Agent 记忆和当日对话记录中提取工作信息，而非依赖 git log。** 只有在记忆和对话信息不足时，才询问人类补充。
...
扫描当天与开发者的对话记录，提取所有已完成的工作内容：

- 开发者要求你完成的开发任务
- 你帮开发者写的代码、调试的bug、查阅的文档
- 你和开发者讨论的技术决策
...
|---------|------|--------|
| 详细描述 | 信息充分 | 直接生成报告 |
| 简短但可理解 | 部分充分 | 追问 1-2 个关键细节 |
| 模糊回答 | 信息不足 | 提供选择题追问 |
| "没什么" | 可能真的没进度 | 记录为低产出日，不追问 |
| 不耐烦 | 停止追问 | 用已有信息生成报告 |
