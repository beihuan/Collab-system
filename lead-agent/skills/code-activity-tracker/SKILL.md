...
|-------|-------------------------------|
| progress-reporter | Auto-fills git activity section of progress report |
| blocker-notifier | Detects lack of code activity as potential blocker signal |
| progress-reviewer | PM Agent uses code activity to validate reported progress |
